\tongjisetup{
  ...
  ctitle={电力系统的脆弱性\\分析与量化评估研究},
  cheadingtitle={电力系统的脆弱性分析与量化评估研究},    %用于页眉的标题，不要换行
  cauthor={李炅聪},
  ...
  % 英文信息
  %=========
  etitle={Research on Vulnerability Analysis and \\Quantitative Evaluation of Power System \\with Wind Farm},
  eauthor={Liu Xuejiao},
